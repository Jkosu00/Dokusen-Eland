...
class CellResolver:
    ...
    def resolver_casilla(self, jugador, casilla, turno_actual=1, partida_id=None):
        """
        ...
        if casilla.tipo == TIPO_SALIDA:
            ...
            return self.resolver_isla(jugador, casilla, turno_actual, partida_id)

        elif casilla.tipo == TIPO_EVENTO:
            return self.resolver_evento(jugador, casilla)

        elif casilla.tipo == TIPO_ROAD_PONEGLYPH:
            return self.resolver_road_poneglyph(jugador, casilla, turno_actual, partida_id)
    ...
    def resolver_isla(self, jugador, casilla, turno_actual, partida_id=None):
        resultado = self.property_rules.analizar_isla(
            jugador,
            casilla,
            turno_actual,
            partida_id
    ...
    def resolver_road_poneglyph(self, jugador, casilla, turno_actual, partida_id=None):
        resultado = self.poneglyph_rules.analizar_poneglyph(
            jugador,
            casilla,
            turno_actual,
            partida_id
